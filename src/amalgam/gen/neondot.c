...
void xnn_qd8_f32_qc4w_bl_gemm_minmax_ukernel_1x8c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (size_t nb=0; nb < n_blocks; ++nb) {
      ...
      const float32x4_t vfilter_output_scale0123 = vcvt_f32_f16(vld1_f16(w)); w = (const uint16_t*) w + 4;
      const float32x4_t vfilter_output_scale4567 = vcvt_f32_f16(vld1_f16(w)); w = (const uint16_t*) w + 4;
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    #elif defined(SCALE_DTYPE_BF16)
      /*
      const uint16x4_t temp0123 = vld1_u16(w); w = (const uint16_t*) w + 4;
      const uint16x4_t temp4567 = vld1_u16(w); w = (const uint16_t*) w + 4;
      const uint32x4_t expanded0123 = vshll_n_u16(temp0123, 16);
      const uint32x4_t expanded4567 = vshll_n_u16(temp4567, 16);
      const float32x4_t vfilter_output_scale0123 = vreinterpretq_f32_u32(expanded0123);
      const float32x4_t vfilter_output_scale4567 = vreinterpretq_f32_u32(expanded4567);
      */
...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_4x16c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    const int8_t* restrict a,
...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_4x16c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    const int8_t* restrict a,
...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_4x8c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    const int8_t* restrict a,
...
void xnn_qd8_f32_qc8w_igemm_minmax_ukernel_1x8c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
...
void xnn_qd8_f32_qc8w_igemm_minmax_ukernel_4x16c4__neondot(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
