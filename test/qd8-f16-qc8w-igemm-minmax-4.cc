...
std::vector<GemmTestParams> CreateTests1(
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  INSTANTIATE_TEST_SUITE_P(
      QD8_F16_QC8W_IGEMM_MINMAX_2X8C8__AVX512SKX, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/2, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          /*is_igemm=*/true,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc8w_igemm_minmax_ukernel_2x8c8__avx512skx,
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F16_QC8W_IGEMM_MINMAX_4X8C8__AVX512SKX, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/4, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          /*is_igemm=*/true,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc8w_igemm_minmax_ukernel_4x8c8__avx512skx,
                        xnn_init_f16_minmax_avx_params,
                        xnn_pack_qs8_conv_goki_w);
          },
          []() {
